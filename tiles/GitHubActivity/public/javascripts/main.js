...
function doIt( host ) {
    ...
    var oauth2SuccessCallback = function(ticketID) {
        ...
        //debugger;
        osapi.http.get({
            'href' : host + '/GitHubActivity/oauth/query?' +
                'id=' + ticketID +
                "&ts=" + new Date().getTime() +
                "&ticketID=" + ticketID +
                "&query=" + query,
            ...
            'authz': 'signed'
                ...
                $("#btn_submit").click( function() {
                    ...
                    //debugger;
                    var href =  host + '/GitHubActivity/oauth/query?' +
                        'id=' + "all" +
                        "&ts=" + new Date().getTime() +
                        "&ticketID=" + ticketID +
                        "&query=" + query;
                        ...
                        'authz': 'signed'
                            ...
                            else
                            {
                                ...
                                if (json == undefined || json['id'] == undefined)
                                {
                                    ...
                                    //debugger;
                                    var href =  host + '/GitHubActivity/oauth/post?' +
                                        'id=' + "all" +
                                        "&ts=" + new Date().getTime() +
                                        "&ticketID=" + ticketID +
                                        "&query=" + query;
    ...
    var options = {
        ...
        authorizeUrl : host + '/GitHubActivity/oauth/authorizeUrl',
